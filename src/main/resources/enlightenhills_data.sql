INSERT INTO `holidays` (`date`,`reason`,`type`,`created_at`, `created_by`)
...
INSERT INTO `holidays` (`date`,`reason`,`type`,`created_at`, `created_by`)
  VALUES (' Sept 11 ','Ganesh Chaturthi','FESTIVAL',CURDATE(),'DBA');
...
INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Admin','admin@enlightenhills.com','9873524142','admin', 1 ,CURDATE(),'DBA');
  
 DELETE FROM person WHERE role_id = 1;
 
 INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Admin','admin@enlightenhills.com','3443434343','$2a$12$1vXEPJKY5QutxwJsXfOtsOzo/WeAdrNoUSE3oIphZpwPAxgUr3rXy', 1 ,CURDATE(),'DBA');

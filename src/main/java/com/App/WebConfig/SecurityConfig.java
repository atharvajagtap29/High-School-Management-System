...
public class SecurityConfig {
	...
	@Bean
	SecurityFilterChain defaulSecurityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        ...
        http.csrf((csrf) -> csrf.ignoringRequestMatchers(mvcMatcherBuilder.pattern("/saveMsg"))
                        ...
                        .requestMatchers(mvcMatcherBuilder.pattern("/aboutus")).permitAll()
                ...
                .httpBasic(Customizer.withDefaults());   // in order for API testing, you have to enable httpBasic() and remove .disable().
